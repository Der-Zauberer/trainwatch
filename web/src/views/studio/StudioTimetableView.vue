<template>
    <div class="container-xl" v-if="!route.params.id">
        <TableComponent v-model="parameter" :resource="timetables" :header="[ $t('entity.general.id'), $t('entity.general.name') ]" @add="router.push({ name: 'studio_timetable_edit', params: { id: 'new' } })">
    ...
    <EditFormComponent v-if="edit.value" :type="'timetable'" :value="edit.value" @close="(router.back(), timetables.reload())">
